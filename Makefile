...
#    Updated: 2023/09/04 02:33:16 by fbosch           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME) : $(OBJ) $(OBJ_BUILT) $(OBJ_ENTRY) $(OBJ_LEXER) $(OBJ_PARSER)
	@$(CC) $(CFLAGS) $(OBJ) $(OBJ_BUILT) $(OBJ_ENTRY) $(OBJ_LEXER) $(OBJ_PARSER) $(LIB_ADD_DIR) $(LIB_SEARCH) $(LIB_A) -o $@
